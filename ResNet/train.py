...
def _parse_args():
  ...
  parser.add_argument("--batch_size", type=int, default=4, help="batch for training")
  parser.add_argument("--num_class", type=int, default=2, help="number of class")
  parser.add_argument("--model", type=str, default="resnet34", help="resnet34, resnet152, inception_v3, densenet169, or densenet201 ")
...
class Train(object):
  def __init__(self, args):
    ...
    if args.check_point_fn is not None:
      ...
      self.model = FineTuneNet(args.model, args.num_class)
    ...
    self.regularization = ComputeReguarizationLoss(self.model.named_parameters(), lm=1.0e3)

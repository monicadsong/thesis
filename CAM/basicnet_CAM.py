...
CAM_DIR = '/data/vision/oliva/scratch/monica/CAM/BASICNET'
...
def extract_frames(video_name):
    ...
    with open(os.path.join('test_jan13_2_dict.p'), 'rb') as f:
        data = pickle.load(f)
